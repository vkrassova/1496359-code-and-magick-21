...
(function () {
  ...
  const wizardCoat = setupWizard.querySelector(`.setup-wizard .wizard-coat`);
  const wizardEyes = setupWizard.querySelector(`.setup-wizard .wizard-eyes`);
  const fireballWrapper = setupWizard.querySelector(`.setup-fireball-wrap`);
